...
var ASM_CONSTS = {
  15564: () => { FS.mkdir('/data'); FS.mount(NODEFS, { root : '.' }, '/data'); },  
 15626: () => { console.log('你好，Emscripten！') },  
 15664: () => { var k = 42; console.log('The answer is:', k); },  
 15710: () => { var k = 42; console.log('The answer is:', k); },  
 15756: ($0, $1, $2) => { return $0 + $1 + $2; },  
 15781: ($0, $1) => { console.log('addr of buf:', $0); console.log('sqrt(pi):', $1); },  
 15848: ($0, $1) => { return $0 * $1; },  
 15868: function() { console.log('arguments count:', arguments.length); for (var i = 0; i < arguments.length; i++) { console.log('$', i, ':', arguments[i]); } },  
 16010: () => { return 42 },  
 16020: () => { return 3.14159 }
};
