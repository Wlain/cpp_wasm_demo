...
var ASM_CONSTS = {
  17588: () => { FS.mount(NODEFS, { root : '.' }, '/'); },  
 17627: () => { FS.mkdir('/temp'); FS.mount(NODEFS, { root : '.' }, '/temp'); }
};
...
/** @type {function(...*):?} */
var _openFiles = Module["_openFiles"] = createExportWrapper("openFiles");

/** @type {function(...*):?} */
var _inputFile = Module["_inputFile"] = createExportWrapper("inputFile");
