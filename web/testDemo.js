...
var ASM_CONSTS = {
  15628: () => { FS.mkdir('/data'); FS.mount(NODEFS, { root : '.' }, '/data'); },  
 15690: () => { console.log('你好，Emscripten！') },  
 15728: () => { var k = 42; console.log('The answer is:', k); },  
 15774: () => { var k = 42; console.log('The answer is:', k); },  
 15820: ($0, $1, $2) => { return $0 + $1 + $2; },  
 15845: ($0, $1) => { console.log('addr of buf:', $0); console.log('sqrt(pi):', $1); },  
 15912: ($0, $1) => { return $0 * $1; },  
 15932: function() { console.log('arguments count:', arguments.length); for (var i = 0; i < arguments.length; i++) { console.log('$', i, ':', arguments[i]); } },  
 16074: () => { return 42 },  
 16084: () => { return 3.14159 }
};
